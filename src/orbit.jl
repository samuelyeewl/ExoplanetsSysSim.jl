...
struct Orbit     
  ...
  incl_mut::Float64      # mutual inclination with respect to system mean plane
end
...
function set!(o::Orbit, P::Float64, e::Float64, i::Float64, w::Float64, asc_node::Float64, M::Float64, i_mut::Float64=0.0) 
 o.P = P
 o.ecc = e
 o.incl = i
 o.omega = w
